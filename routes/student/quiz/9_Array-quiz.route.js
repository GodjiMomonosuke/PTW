...
var ADRI_Answer = "https://drive.google.com/file/d/1qtB387WF-amNGdhn10SdT9YyeexWOrzt/preview"
      ...
      if(Object.keys(StudentAnswer).length === 0){
        ...
        MongoClient.connect(url, function(err, db) {
          ...
          dbo.collection("StudentRecommendation").find(query).toArray(function(err, RecommendaResult) {
            ...
            res.render('student/quiz/9_Array-quiz', { person ,StudentAnswer,RecommendaResult,ADRI,ADRI_Expect});
          });
        });
      }
      db.close();
